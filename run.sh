...
terraform_dir="/home/osamaayman/devops/dynamic-devops-roadmap/terraform"
ansible_dir="/home/osamaayman/devops/dynamic-devops-roadmap/Ansible"
...
update_inventory() {
   ...
   echo -e "jenkins-ec2 ansible_host=${ip_address} ansible_user=ubuntu ansible_ssh_private_key_file=/home/osamaayman/.ssh/jenkins-ec2.pub" > "$ansible_dir/inventory.txt"
